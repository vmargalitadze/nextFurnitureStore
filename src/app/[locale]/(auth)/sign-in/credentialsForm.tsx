    ...
    <>
      <div className="flex flex-col gap-4 mb-6">
        <Button
          ...
          className="w-full flex items-center justify-center gap-2 px-4 py-2 text-lg font-semibold text-white bg-[#4285F4] rounded-lg hover:bg-[#357ae8] transition-colors"
        >
          {googleLoading ? (
