...
const Filter = ({
  ...
  const BrandFilter = Array.from(new Set(Products.map((product) => product.Brand)));
    ...
    return (
        <>
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 max-w-[1720px] mx-auto border-b border-bdr-clr dark:border-bdr-clr-drk pb-8 ">
                <div>
                ...
                <div className="max-w-[562px] w-full flex flex-col gap-8 md:gap-12">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="flex flex-col gap-4">
                            <div className="text-lg font-medium text-title dark:text-white">ფასი</div>
                            <div className="grid grid-cols-2 gap-[10px]">
                                <div className="py-[10px] px-3 border border-title dark:border-white-light flex items-center gap-[5px]">
                                    <span className="text-title dark:text-white font-medium leading-none">Min:</span>
                                    <input
                                        className="pl-[8px] w-full bg-transparent text-title dark:text-white placeholder:text-title dark:placeholder:text-white font-medium leading-none outline-none"
                                        type="number"
                        ...
                        <div className="flex flex-col gap-4">
        <div className="text-lg font-medium text-title dark:text-white">ბრენდი</div>
        <div className="relative">
            <select
                className="w-full appearance-none py-3 px-4 border border-title dark:border-white-light bg-white dark:bg-dark text-title dark:text-white font-medium leading-none rounded-md outline-none"
                value={selectedBrand}
            ...
            <div className="absolute inset-y-0 right-4 flex items-center pointer-events-none">
                <svg className="w-4 h-4 text-title dark:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
